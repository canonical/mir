...
typedef struct
{
    ...
    unsigned int drm_format, android_format;
...
static const Detail detail[mir_pixel_formats] =
{
    ...
    {mir_pixel_format_abgr_8888, 4, 8,8,8,8, "abgr_8888",
         ...
         DRM_FORMAT_ABGR8888, HAL_PIXEL_FORMAT_RGBA_8888},
    {mir_pixel_format_xbgr_8888, 4, 8,8,8,8, "xbgr_8888",
         GL_RGBA, GL_UNSIGNED_BYTE,
         DRM_FORMAT_XBGR8888, HAL_PIXEL_FORMAT_RGBX_8888},
    {mir_pixel_format_argb_8888, 4, 8,8,8,8, "argb_8888",
         GL_BGRA_EXT, GL_UNSIGNED_BYTE,
         DRM_FORMAT_ARGB8888, HAL_PIXEL_FORMAT_BGRA_8888},
    {mir_pixel_format_xrgb_8888, 4, 8,8,8,8, "xrgb_8888",
         GL_BGRA_EXT, GL_UNSIGNED_BYTE,
         DRM_FORMAT_XRGB8888, HAL_PIXEL_FORMAT_BGRA_8888/* no "X" equivalent*/},
...
MirPixelFormat from_drm_format(unsigned int g)
{
    for (int i = 0; i < mir_pixel_formats; ++i)
        if (detail[i].drm_format == g)
            return detail[i].mir_format;

    switch (g)
    {
    case GBM_BO_FORMAT_ARGB8888: return mir_pixel_format_argb_8888;
    case GBM_BO_FORMAT_XRGB8888: return mir_pixel_format_xrgb_8888;
    default:                     return mir_pixel_format_invalid;
    }
}

unsigned int to_drm_format(MirPixelFormat f)
{
    return is_valid(f) ? detail[f].drm_format : 0;
}
