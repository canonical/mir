...
mir::EventUPtr convert_touch_actions_to_change(MirTouchEvent const* ev)
{
    ...
    {
        ret->to_input()->to_motion()->pointer_coordinates(i).set_action(mir_touch_action_change);
    }
    return ret;
}
...
mir::EventUPtr add_missing_down(MirEvent const* valid_ev, MirTouchEvent const* ev, MirTouchId missing_id)
{
    ...
    {
        ret->to_input()->to_motion()->pointer_coordinates(existing_index).set_action(mir_touch_action_down);
    }
    else
    {
...
mir::EventUPtr add_missing_up(MirEvent const* valid_ev, MirTouchId missing_an_up_id)
{
    ...
    ret->to_input()->to_motion()->pointer_coordinates(index).set_action(mir_touch_action_up);
