...
static EGLConfig select_egl_config_with_format(EGLDisplay egl_display, geom::PixelFormat display_format)
{
    ...
    eglChooseConfig(egl_display, required_egl_config_attr, matching_configs.data(), num_potential_configs, &num_match_configs);
...
mga::AndroidDisplay::AndroidDisplay(std::shared_ptr<mga::AndroidDisplayBufferFactory> const& db_factory,
    ...
    : db_factory{db_factory},
      ...
      egl_shared_context{egl_display,
                         eglCreateContext(
      ...
      display_buffer{db_factory->create_display_buffer(
          display_device, egl_display, egl_config, egl_shared_context)},
...
std::unique_ptr<mg::GLContext> mga::AndroidDisplay::create_gl_context()
{
    return std::unique_ptr<AndroidGLContext>{
        new AndroidGLContext{egl_display, egl_config, egl_shared_context}};
}
