...
std::shared_ptr<mga::AndroidDisplay> mga::AndroidDisplayFactory::create_gpu_display() const
{
...
std::shared_ptr<mga::HWCDisplay> mga::AndroidDisplayFactory::create_hwc_display(std::shared_ptr<HWCDevice> const& hwc_device) const
{
    auto native_window = std::make_shared< ::android::FramebufferNativeWindow>();
    auto window = std::make_shared<mga::AndroidFramebufferWindow> (native_window);
