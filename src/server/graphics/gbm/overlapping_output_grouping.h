...
#ifndef MIR_GRAPHICS_GBM_OVERLAPPING_OUTPUT_GROUPING_H_
#define MIR_GRAPHICS_GBM_OVERLAPPING_OUTPUT_GROUPING_H_
...
#endif /* MIR_GRAPHICS_GBM_OVERLAPPING_OUTPUT_GROUPING_H_ */
