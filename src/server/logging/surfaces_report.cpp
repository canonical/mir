...
void ml::SurfacesReport::surface_created(msh::BasicSurface* const surface)
{
...
void ml::SurfacesReport::surface_added(msh::BasicSurface* const surface)
{
    std::lock_guard<std::mutex> lock(mutex);
...
void ml::SurfacesReport::surface_removed(msh::BasicSurface* const surface)
{
    std::lock_guard<std::mutex> lock(mutex);
...
void ml::SurfacesReport::surface_deleted(msh::BasicSurface* const surface)
{
    std::lock_guard<std::mutex> lock(mutex);
