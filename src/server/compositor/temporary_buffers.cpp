...
void mc::TemporaryBuffer::read(std::function<void(unsigned char const*)> const&)
{
    BOOST_THROW_EXCEPTION(
        std::runtime_error("Read from temporary buffer snapshot is ill advised and indicates programmer error"));
}
