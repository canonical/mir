...
auto mir::Server::the_decoration_renderer_strategy() const
    -> std::shared_ptr<shell::decoration::DecorationStrategy>
{
    return self->server_config->the_decoration_renderer_strategy();
}

void mir::Server::set_the_decoration_renderer_strategy(
    std::shared_ptr<shell::decoration::DecorationStrategy> strategy)
{
