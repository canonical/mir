...
public:
    ...
    {
        if (keyboard_trigger_registry->matches_any_trigger(*event))
            return;
...
mf::WlSeat::WlSeat(
    ...
    :   Global(display, Version<9>()),
        ...
        keyboard_observer{std::make_shared<KeyboardObserver>(*this, surface_registry, keyboard_trigger_registry)},
