...
private:
    struct KeyboardEventFilter : public mi::EventFilter
    {
        ...
        {
            // TODO use the keyboard trigger to get the type and act on that.
    ...
    uint32_t modifiers, uint32_t keysym, uint32_t type, struct wl_resource* id)
{
    ...
    new KeyboardSymTrigger{modifiers, keysym, id, registration_type};
}
