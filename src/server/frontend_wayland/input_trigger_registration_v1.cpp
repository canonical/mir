...
public:
    ...
    public:
        ...
        void register_modifier_trigger(
            uint32_t modifiers, uint32_t hold_delay, uint32_t tap_count, struct wl_resource* id) override;
...
void InputTriggerRegistrationManagerV1::Instance::register_modifier_trigger(
