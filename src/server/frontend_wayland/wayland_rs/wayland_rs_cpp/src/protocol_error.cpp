...
auto mir::wayland::ProtocolError::what() const noexcept -> char const* { return what_.c_str(); }

auto mir::wayland::ProtocolError::object_id() const noexcept -> uint32_t { return object_id_; }

auto mir::wayland::ProtocolError::code() const noexcept -> uint32_t { return code_; }

auto mir::wayland::ProtocolError::message() const noexcept -> std::string const& { return message_; }
