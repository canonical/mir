...
#ifndef MIR_FRONTEND_XDG_SHELL_UNSTABLE_V6_H
#define MIR_FRONTEND_XDG_SHELL_UNSTABLE_V6_H
...
class XdgShellUnstableV6 : public wayland::XdgShellV6
{
public:
    XdgShellUnstableV6(struct wl_display* display, std::shared_ptr<Shell> const shell, WlSeat& seat);
...
#endif // MIR_FRONTEND_XDG_SHELL_UNSTABLE_V6_H
