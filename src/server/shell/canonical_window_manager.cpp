...
bool msh::CanonicalWindowManagerPolicy::handle_key_event(MirKeyInputEvent const* event)
{
...
bool msh::CanonicalWindowManagerPolicy::handle_touch_event(MirTouchInputEvent const* event)
{
...
bool msh::CanonicalWindowManagerPolicy::handle_pointer_event(MirPointerInputEvent const* event)
{
