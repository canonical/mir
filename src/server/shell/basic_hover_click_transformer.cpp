...
msh::BasicHoverClickTransformer::BasicHoverClickTransformer(
    ...
    cursor_observer{[&]
                    {
                        struct CursorListener : public input::CursorObserver
                        {
                            explicit CursorListener(mir::Synchronised<MutableState>& mutable_state) :
                        ...
                        return std::make_shared<CursorListener>(mutable_state);
                    }()}
{
