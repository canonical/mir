...
void mir::report::lttng::SessionMediatorReport::session_start_prompt_session_called(std::string const& app_name, pid_t base_process)
{
    mir_tracepoint(mir_server_session_mediator, session_start_prompt_session_called, app_name.c_str(), base_process);
}

void mir::report::lttng::SessionMediatorReport::session_add_prompt_provider_called(std::string const& app_name, pid_t process)
{
    mir_tracepoint(mir_server_session_mediator, session_add_prompt_provider_called, app_name.c_str(), process);
}
