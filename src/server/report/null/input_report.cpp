...
void mrn::InputReport::open_input_device(char const* /* name */, char const* /* platform */)
{
}

void mrn::InputReport::failure_opening_input_device(char const* /* name */, char const* /* platform */)
{
}
