...
public:
    ...
    void for_each_trust_session_with_participant(std::weak_ptr<Session> const& session, TrustType trust_type, std::function<void(std::shared_ptr<TrustSession> const&)> f) const;
    void for_each_trust_session_with_participant(std::weak_ptr<Session> const& session, std::function<void(std::shared_ptr<TrustSession> const&)> f) const;
