...
void ms::NullSurfaceObserver::entered_output(Surface const*, graphics::DisplayConfigurationOutputId) {};
void ms::NullSurfaceObserver::left_output(Surface const*, graphics::DisplayConfigurationOutputId) {};
