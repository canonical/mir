...
void ms::NullSurfaceObserver::entered_output(
    Surface const*,
    graphics::DisplayConfigurationOutputId const&,
    std::function<bool(graphics::DisplayConfigurationOutputId const&)> const&) {};
void ms::NullSurfaceObserver::left_output(
    Surface const*,
    graphics::DisplayConfigurationOutputId const&,
    std::function<bool(graphics::DisplayConfigurationOutputId const&)> const&) {};
