...
#define MIR_SESSION_MEDIATOR_EVENT_METHOD(event)                               \
    void mir::lttng::SessionMediatorReport::event(std::string const& app_name) \
    {                                                                          \
...
void mir::lttng::SessionMediatorReport::session_error(std::string const& app_name, char const* method, std::string const& what)
{
