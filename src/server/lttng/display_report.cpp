...
void mir::lttng::DisplayReport::report_egl_configuration(EGLDisplay /*disp*/, EGLConfig /*config*/)
{
}


void mir::lttng::DisplayReport::report_drm_master_failure(int error)
{
    mir_tracepoint(mir_server_display, report_drm_master_failure, strerror(error));
}


void mir::lttng::DisplayReport::report_hwc_composition_in_use(int major, int minor)
{
