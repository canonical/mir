...
/** @} */
    ...
    // "static inline" is an ugly hack to preserve mirserver ABI (TODO remove after changes are "cherry-picked")
    static inline CachedPtr<frontend::PointerInputDispatcher> pointer_input_dispatcher;
