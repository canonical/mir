...
public:
    ...
    auto the_decoration_renderer_strategy() -> std::shared_ptr<mir::shell::decoration::DecorationStrategy>;
    void set_the_decoration_renderer_strategy(std::shared_ptr<mir::shell::decoration::DecorationStrategy> strategy);
...
private:
    ...
    std::map<std::string, WaylandProtocolExtensionFilter> wayland_extension_policy_map;
