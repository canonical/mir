...
public:
    ...
    using DecorationManagerInit = std::function<std::shared_ptr<shell::decoration::Manager>()>;
    virtual void set_the_decoration_manager_init(DecorationManagerInit init_cb) = 0;
