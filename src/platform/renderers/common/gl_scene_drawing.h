...
/**
 * Tessellate `renderable` into the triangles that will be used to draw it.
 *
 * By default this is just the 4 vertices of a rectangle.
 */
 ...
 *
 * \param [in] context     Frame-global drawing state
 * \param [in] renderable  The renderable to draw
 * \param [in] texture     A texture view onto *renderable*'s buffer
 * \param [in] factory     Factory providing the program *texture* is drawn with
 * \param [in] primitives  The tessellation of *renderable*
 */
void draw(
