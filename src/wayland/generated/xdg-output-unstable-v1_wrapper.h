...
public:
    ...
    XdgOutputManagerV1(struct wl_client* client, struct wl_resource* parent, Version<2> static_version);
...
public:
    ...
    XdgOutputV1(struct wl_client* client, struct wl_resource* parent, Version<2> static_version);
