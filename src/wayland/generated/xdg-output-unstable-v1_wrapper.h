...
public:
    ...
    XdgOutputManagerV1(struct wl_client* client, int runtime_version, Version<2> static_version);
...
public:
    ...
    XdgOutputV1(struct wl_client* client, int runtime_version, Version<2> static_version);
