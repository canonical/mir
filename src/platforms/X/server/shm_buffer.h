 ...
 * under the term of the GNU Lesser General Public License version 3,
...
#ifndef MIR_GRAPHICS_X_SHM_BUFFER_H_
#define MIR_GRAPHICS_X_SHM_BUFFER_H_
...
#endif /* MIR_GRAPHICS_X_SHM_BUFFER_H_ */
