...
#ifndef MIR_CLIENT_X_MESA_NATIVE_DISPLAY_CONTAINER_H_
#define MIR_CLIENT_X_MESA_NATIVE_DISPLAY_CONTAINER_H_
...
#endif // MIR_CLIENT_X_MESA_NATIVE_DISPLAY_CONTAINER_H_
