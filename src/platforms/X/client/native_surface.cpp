...
{
    auto s = static_cast<mclx::NativeSurface*>(surface);
...
mclx::NativeSurface::NativeSurface(EGLNativeSurface& surface)
...
int mclx::NativeSurface::advance_buffer(MirBufferPackage* buffer_package)
try
{
    /*
...
int mclx::NativeSurface::get_parameters(MirSurfaceParameters* surface_parameters)
try
{
...
int mclx::NativeSurface::set_swapinterval(int interval)
try
{
