...
mclx::MesaNativeDisplayContainer* default_display_container{nullptr};
...
mcl::EGLNativeDisplayContainer& mcl::EGLNativeDisplayContainer::instance()
{
    ...
    if (!default_display_container)
        default_display_container = new mclx::MesaNativeDisplayContainer;

    return *default_display_container;
}

mclx::MesaNativeDisplayContainer::MesaNativeDisplayContainer()
{
}
...
bool mclx::MesaNativeDisplayContainer::validate(MirEGLNativeDisplayType display) const
{
    std::lock_guard<std::mutex> lg(guard);
...
mclx::MesaNativeDisplayContainer::create(client::ClientPlatform* platform)
{
...
void mclx::MesaNativeDisplayContainer::release(MirEGLNativeDisplayType display)
{
    std::lock_guard<std::mutex> lg(guard);
