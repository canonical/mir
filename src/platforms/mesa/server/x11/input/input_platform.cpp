            ...
            case ButtonRelease:
                {
                    ...
                    if (xbev.type == ButtonPress)
                    {
                        ...
                        if (xbev.button == 8)
                            buttons_pressed |= mir_pointer_button_side;
                        if (xbev.button == 9)
                            buttons_pressed |= mir_pointer_button_extra;
                        if (xbev.button == 10)
                            buttons_pressed |= mir_pointer_button_task;
                    }
...
#endif
                    auto const old_pointer_pos = core_pointer->pointer_pos;
                    core_pointer->pointer_pos = geometry::Point{xmev.x, xmev.y};
                    auto const movement = core_pointer->pointer_pos - old_pointer_pos;
