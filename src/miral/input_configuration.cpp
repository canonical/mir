...
auto miral::InputConfiguration::Touchpad::operator==(Touchpad const& that) const -> bool
{
...
auto miral::InputConfiguration::Keyboard::operator==(Keyboard const& that) const -> bool
{
