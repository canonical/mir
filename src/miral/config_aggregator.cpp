...
{
    auto const it = std::ranges::find_if(self->sources, [&](auto const& s) { return s.file_path == source.file_path; });
...
void mlc::ConfigAggregator::add_int_attribute(Key const& key, std::string_view description, HandleInt handler)
{
...
void mlc::ConfigAggregator::add_ints_attribute(Key const& key, std::string_view description, HandleInts handler)
{
...
void mlc::ConfigAggregator::add_bool_attribute(Key const& key, std::string_view description, HandleBool handler)
{
...
void mlc::ConfigAggregator::add_float_attribute(Key const& key, std::string_view description, HandleFloat handler)
{
...
void mlc::ConfigAggregator::add_floats_attribute(Key const& key, std::string_view description, HandleFloats handler)
{
...
void mlc::ConfigAggregator::add_string_attribute(Key const& key, std::string_view description, HandleString handler)
{
...
void mlc::ConfigAggregator::add_strings_attribute(Key const& key, std::string_view description, HandleStrings handler)
{
