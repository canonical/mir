...
static XcursorBool _XcursorReadUInt(XcursorFile *file, XcursorUInt *u)
{
    ...
    if ((*file->read)(file, bytes, 4) != 4)
        return XcursorFalse;
    *u = (((XcursorUInt)bytes[0] << 0) | ((XcursorUInt)bytes[1] << 8) | ((XcursorUInt)bytes[2] << 16) |
...
static XcursorBool _XcursorFileReadChunkHeader(XcursorFile *file,
                                               XcursorFileHeader *fileHeader,
                                               int toc,
...
static void load_all_cursors_from_dir(const char *path,
                                      int size,
