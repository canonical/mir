...
miral::WindowManagerTools::WindowManagerTools(WindowManagerToolsImplementation* tools) : tools{tools} {}
...
void miral::WindowManagerTools::add_tree_to_workspace(miral::Window const& window,
                                                      std::shared_ptr<miral::Workspace> const& workspace)
{
    tools->add_tree_to_workspace(window, workspace);
}

void miral::WindowManagerTools::remove_tree_from_workspace(miral::Window const& window,
                                                           std::shared_ptr<miral::Workspace> const& workspace)
{
...
void miral::WindowManagerTools::for_each_window_in_workspace(std::shared_ptr<miral::Workspace> const& workspace,
