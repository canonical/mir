...
void miral::WindowManagementPolicy::advise_adding_to_workspace(std::shared_ptr<Workspace> const&,
                                                               std::vector<Window> const&)
{}
void miral::WindowManagementPolicy::advise_removing_from_workspace(std::shared_ptr<Workspace> const&,
                                                                   std::vector<Window> const&)
{}
