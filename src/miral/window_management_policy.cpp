...
void miral::WindowManagementPolicy::advise_raise(std::span<Window const>) {}
void miral::WindowManagementPolicy::advise_adding_to_workspace(std::shared_ptr<Workspace> const&, std::span<Window const>) {}
void miral::WindowManagementPolicy::advise_removing_from_workspace(std::shared_ptr<Workspace> const&, std::span<Window const>) {}
