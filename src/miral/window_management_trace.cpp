...
{\
    ...
    mir::log_warning("{} throws {}", __func__, out.str().c_str());\
    throw;\
}
...
try {
    ...
    mir::log_info("{} -> {}", __func__, dump_of(result).c_str());
    trace_count++;
    return result;
}
MIRAL_TRACE_EXCEPTION
...
try {
    ...
    mir::log_info("{} -> {}", __func__, result.application()->name().c_str());
    trace_count++;
    return result;
}
MIRAL_TRACE_EXCEPTION
...
try {
    ...
    mir::log_info("{} -> {}", __func__, result.name().c_str());
    trace_count++;
    return result;
}
MIRAL_TRACE_EXCEPTION
...
try {
    log_input();
    mir::log_info("{} -> {}", __func__, dump_of(window).c_str());
    trace_count++;
...
try {
    ...
    mir::log_info("{} hint={} -> {}", __func__, dump_of(hint).c_str(), dump_of(result).c_str());
    trace_count++;
    return result;
}
MIRAL_TRACE_EXCEPTION
...
try {
    ...
    mir::log_info("{} cursor={}", __func__, out.str().c_str());
    trace_count++;
    return result;
}
MIRAL_TRACE_EXCEPTION
...
try {
    ...
    std::stringstream out;
    out << result;
    mir::log_info("{} -> {}", __func__, out.str().c_str());
    trace_count++;
    return result;
}
MIRAL_TRACE_EXCEPTION
...
try {
    log_input();
    mir::log_info("{} modifications={} window_info={}", __func__, dump_of(modifications).c_str(), dump_of(window_info).c_str());
...
try {
    ...
    std::stringstream out;
    out << movement;
    mir::log_info("{} movement={}", __func__, out.str().c_str());
    trace_count++;
...
try {
    ...
    std::stringstream out;
    out << movement;
    mir::log_info("{} window={} -> {}", __func__, dump_of(window).c_str(), out.str().c_str());
    trace_count++;
...
try {
    log_input();
    mir::log_info("{} app={}", __func__, dump_of(app).c_str());
    trace_count++;
...
try {
    log_input();
    mir::log_info("{} app={}", __func__, dump_of(window).c_str());
    trace_count++;
...
try {
    log_input();
    mir::log_info("{} root={}", __func__, dump_of(root).c_str());
    trace_count++;
...
try {
    log_input();
    mir::log_info("{} first={} second={}", __func__, dump_of(first).c_str(), dump_of(second).c_str());
    trace_count++;
...
try {
    log_input();
    mir::log_info("{} window_info={}, modifications={}",
...
try {
    mir::log_info("{} window={}, workspace ={:p}", __func__, dump_of(window).c_str(), static_cast<void*>(workspace.get()));
...
try {
    mir::log_info("{} to_workspace={:p}, from_workspace={:p}", __func__, static_cast<void*>(to_workspace.get()), static_cast<void*>(from_workspace.get()));
...
try {
    mir::log_info("{} window={}", __func__, dump_of(window).c_str());
...
try {
    mir::log_info("{} workspace ={:p}", __func__, static_cast<void*>(workspace.get()));
...
try {
    ...
    mir::log_info("{} app_info={}, requested_specification={} -> {}",
...
try {
    mir::log_info("{} window_info={}", __func__, dump_of(window_info).c_str());
...
try {
    log_input = [event, this]
        {
            mir::log_info("handle_keyboard_event event={}", dump_of(event).c_str());
            log_input = []{};
        };
...
try {
    log_input = [event, this]
        {
            mir::log_info("handle_touch_event event={}", dump_of(event).c_str());
            log_input = []{};
        };
...
try {
    log_input = [event, this]
        {
            mir::log_info("handle_pointer_event event={}", dump_of(event).c_str());
            log_input = []{};
        };
...
try {
    std::stringstream out;
    out << movement;
    mir::log_info("{} window_info={}, movement={}", __func__, dump_of(window_info).c_str(), out.str().c_str());
...
try {
    mir::log_info("{} application={}", __func__, dump_of(application).c_str());
...
try {
    mir::log_info("{} window_info={}, state={}", __func__, dump_of(window_info).c_str(), dump_of(state).c_str());
...
try {
    mir::log_info("{} window_info={}, top_left={}", __func__, dump_of(window_info).c_str(), dump_of(top_left).c_str());
...
try {
    mir::log_info("{} window_info={}, new_size={}", __func__, dump_of(window_info).c_str(), dump_of(new_size).c_str());
...
try {
    mir::log_info("{} window_info={}", __func__, dump_of(windows).c_str());
...
try {
    mir::log_info("{} workspace={:p}, windows={}", __func__, static_cast<void*>(workspace.get()), dump_of(windows).c_str());
...
try {
    ...
    mir::log_info("{} window_info={}, new_state={}, new_placement={} -> {}", __func__,
...
try {
    mir::log_info("{} output={}", __func__, dump_of(output).c_str());
...
try {
    mir::log_info("{} updated={}, original={}", __func__, dump_of(updated).c_str(), dump_of(original).c_str());
...
try {
    mir::log_info("{} application_zone={}", __func__, dump_of(application_zone).c_str());
...
try {
    std::stringstream out;
    out << point;
    mir::log_info("{} point={}", __func__, out.str().c_str());
