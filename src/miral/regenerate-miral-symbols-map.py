...
#miral::WaylandExtensions::Context::operator*;
    ...
    miral::toolkit::mir_keyboard_event_key_code*;
...
global:
    '''
        ...
        def
        _print_report() :
        print(OLD_STANZAS) new_symbols = False;
    for
        symbol in sorted(SYMBOLS['public']) :
            formatted_symbol =
                '    {};'.format(symbol) if formatted_symbol not in OLD_STANZAS and 'miral::' in formatted_symbol :
            if not new_symbols : new_symbols = True;
                print('  extern "C++" {')
