...
private:
    ...
    {
        ContextCreationRequest(mir_presentation_chain_callback cb, void* context) :
    ...
    std::vector<std::shared_ptr<ContextCreationRequest>> context_requests;
    void context_created(ContextCreationRequest*);
    void context_error(std::string const& error_msg, std::shared_ptr<ContextCreationRequest> const& request);
