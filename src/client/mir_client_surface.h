...
{
  public:
    virtual mir_client::MirSurfaceParameters get_parameters() const = 0;
    virtual std::shared_ptr<ClientBuffer> get_current_buffer() = 0;
    virtual mir_client::MirWaitHandle* next_buffer(mir_client::mir_surface_lifecycle_callback callback, void * context) = 0;
  protected:
    ClientSurface() {}
