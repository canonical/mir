...
TEST_F(ClientSurfaces, can_be_menus)
{
    ...
    auto spec = mir_connection_create_window_spec_for_menu(connection, 640, 480,
...
{
    auto spec = mir_connection_create_window_spec_for_dialog(connection, 640, 480,
...
{
    auto parent = mtf::make_any_surface(connection);
    auto spec = mir_connection_create_window_spec_for_modal_dialog(connection, 640, 480,
