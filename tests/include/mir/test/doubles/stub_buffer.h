    ...
    StubBuffer(geometry::Size const& size)
        : StubBuffer{
              graphics::BufferProperties{
                  ...
                  mir_pixel_format_abgr_8888,
                  graphics::BufferUsage::hardware},
              geometry::Stride{size.height.as_uint32_t() * MIR_BYTES_PER_PIXEL(mir_pixel_format_abgr_8888)}}
    ...
    StubBuffer(geometry::Size const& size, MirPixelFormat const pixel_format)
        : StubBuffer{
              graphics::BufferProperties{
                  ...
                  pixel_format,
                  graphics::BufferUsage::hardware},
                  geometry::Stride{size.height.as_uint32_t() * MIR_BYTES_PER_PIXEL(pixel_format)}}
    {
    }
