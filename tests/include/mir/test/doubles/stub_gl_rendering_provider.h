...
public:
    ...
    auto suitability_for_display(std::shared_ptr<graphics::DisplayTarget> const& /*target*/)
        -> graphics::probe::Result override
    {
        return graphics::probe::dummy; 
    }

    auto make_framebuffer_provider(std::shared_ptr<graphics::DisplayTarget> /*target*/)
