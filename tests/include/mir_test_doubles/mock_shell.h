...
struct MockShell : public frontend::Shell
{
    ...
    MOCK_METHOD2(persistent_id_for, std::vector<uint8_t>(std::shared_ptr<frontend::Session> const&, frontend::SurfaceId));
    MOCK_METHOD1(surface_for_id, std::shared_ptr<scene::Surface>(std::vector<uint8_t> const&));
