...
struct MockAndroidNativeBuffer : public graphics::NativeBuffer
{
    ...
    MOCK_METHOD1(ensure_available_for, void(graphics::android::StreamDepiction));
    MOCK_METHOD2(update_usage, void(graphics::android::NativeFence&, graphics::android::StreamDepiction));
