...
public:
    ...
    std::shared_ptr<mir::graphics::GraphicBufferAllocator> create_buffer_allocator() override;

    std::shared_ptr<mir::graphics::PlatformIpcOperations> make_ipc_operations() const override;
