        ...
        outputs.push_back(
            {
                ...
                card_id,
                {
                    {geom::Size{geom::Width{123}, geom::Height{111}}, 59.9},
                    {geom::Size{geom::Width{123}, geom::Height{111}}, 59.9},
                    {geom::Size{geom::Width{123}, geom::Height{111}}, 59.9}
                },
                geom::Size{geom::Width{324}, geom::Height{642}},
                true,
                false,
        ...
        outputs.push_back(
            {
                ...
                card_id,
                {},
                geom::Size{geom::Width{566}, geom::Height{111}},
                true,
                false,
                geom::Point(),
        ...
        outputs.push_back(
            {
                ...
                card_id,
                {
                    {geom::Size{geom::Width{523}, geom::Height{555}}, 60.0},
                },
                geom::Size{geom::Width{324}, geom::Height{642}},
                true,
                false,
