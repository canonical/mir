...
{
    LayerListTest() :
        source_crop{std::make_shared<mga::IntegerSourceCrop>()},
    ...
    std::shared_ptr<mga::LayerSourceCrop> source_crop;
...
{
    mga::LayerList layerlist{source_crop, {}, 0};
...
TEST_F(LayerListTest, list_iterators)
{
    ...
    mga::LayerList list(source_crop, renderables, additional_layers);
    ...
    mga::LayerList list2(source_crop, {}, additional_layers);
    ...
    mga::LayerList list3(source_crop, renderables, 0);
