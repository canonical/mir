...
TEST_F(AndroidTestFramebufferInit, fb_initialize_CreateContext_ensure_no_share)
{
    using namespace testing;
...
TEST_F(AndroidTestFramebufferInit, fb_initialize_CreateContext_context_attr_null_terminated)
{
    using namespace testing;
