...
TEST_F(ServerRenderWindowTest, driver_wants_a_buffer)
{
    ...
    mga::ServerRenderWindow render_window(mock_swapper, mock_display_commander, mock_display_info, mock_cache);
...
TEST_F(ServerRenderWindowTest, driver_is_done_with_a_buffer_properly)
{
    ...
    EXPECT_CALL(*mock_swapper, compositor_release(buf1))
        .Times(1); 
    EXPECT_CALL(*mock_display_commander, set_next_frontbuffer(buf1))
        .Times(1);
...
TEST_F(ServerRenderWindowTest, driver_swapinterval_request)
{
    ...
    EXPECT_CALL(*mock_display_commander, sync_to_display(false))
        .Times(1);
