...
protected:
    ...
    std::shared_ptr<mga::NativeWindowLogger> anw_logger = std::make_shared<mga::NullNativeWindowLogger>();
...
TEST_F(PlatformBufferIPCPackaging, test_ipc_data_packed_correctly_for_full_ipc_with_fence)
{
    ...
    mga::Platform platform(stub_buffer_allocator, stub_display_builder,
        stub_display_report, anw_logger, mga::OverlayOptimization::enabled, quirks);
