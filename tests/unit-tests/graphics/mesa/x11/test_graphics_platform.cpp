...
class GraphicsPlatformX11 : public ::testing::Test
{
public:
    GraphicsPlatformX11() : logger(std::make_shared<ml::DumbConsoleLogger>())
    {
...
TEST_F(GraphicsPlatformX11, buffer_allocator_creation)
{
    using namespace testing;
...
TEST_F(GraphicsPlatformX11, buffer_creation)
{
    auto platform = create_platform();
    auto allocator = platform->create_buffer_allocator();
...
TEST_F(GraphicsPlatformX11, connection_ipc_package)
{
    auto platform = create_platform();
