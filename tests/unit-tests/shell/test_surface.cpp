...
public:
    ...
    std::weak_ptr<msh::BasicSurface> create_surface(msh::Session*, msh::SurfaceCreationParameters const& )
    {
    ...
    void destroy_surface(std::weak_ptr<msh::BasicSurface> const& )
    {
        reset_surface();
    }
...
private:
    ...
    std::shared_ptr<msh::BasicSurface> dummy_surface;
...
public:
    ...
    MOCK_METHOD2(create_surface, std::weak_ptr<msh::BasicSurface> (msh::Session*, const msh::SurfaceCreationParameters&));

    MOCK_METHOD1(destroy_surface, void (std::weak_ptr<msh::BasicSurface> const&));
