...
TEST_F(ShellSurface, states)
{
    ...
    EXPECT_EQ(mir_surface_state_minimized,
              surf.configure(mir_surface_attrib_state,
                             mir_surface_state_minimised));
    EXPECT_EQ(mir_surface_state_minimised, surf.state());
    ...
    EXPECT_EQ(mir_surface_state_vertmaximized,
              surf.configure(mir_surface_attrib_state,
                             mir_surface_state_vertmaximised));
    EXPECT_EQ(mir_surface_state_vertmaximized, surf.state());

    EXPECT_EQ(mir_surface_state_maximized,
              surf.configure(mir_surface_attrib_state,
                             mir_surface_state_maximised));
    EXPECT_EQ(mir_surface_state_maximized, surf.state());
