...
{
    return mev::make_event(0, 0, mir_keyboard_action_down, 0, 0, mir_input_event_modifier_alt);
}
mir::EventUPtr a_key_up_event()
{
    return mev::make_event(0, 0, mir_keyboard_action_up, 0, 0, mir_input_event_modifier_alt);
}
}
