...
public:
    ...
    const uint64_t msg_auth_code = 16;
...
TEST_F(InputTranslator, accepts_motion_action_with_existing_index)
{
    ...
    droidinput::NotifyMotionArgs motion(some_time, msg_auth_code, device_id, source_id, 0, valid_motion_action,
...
{   // Regression test for LP: #1481570
    ...
    droidinput::NotifyMotionArgs motion(
        some_time, msg_auth_code, device_id, source_id, 0, end_of_gesture,
...
TEST_F(InputTranslator, ignores_motion_with_duplicated_pointerids)
{
    ...
    droidinput::NotifyMotionArgs motion(some_time, msg_auth_code, device_id, source_id, 0, motion_action, no_flags,
...
TEST_F(InputTranslator, forwards_pointer_positions)
{
    ...
    droidinput::NotifyMotionArgs motion(some_time, msg_auth_code, device_id, AINPUT_SOURCE_MOUSE, 0, motion_action, no_flags,
...
TEST_F(InputTranslator, forwards_and_converts_up_down_key_notifications)
{
    ...
    droidinput::NotifyKeyArgs down(some_time, msg_auth_code, device_id, source_id, 0, AKEY_EVENT_ACTION_DOWN,
                                   no_flags, arbitrary_key_code, arbitrary_scan_code, no_modifiers, later_time);
    droidinput::NotifyKeyArgs up(some_time, msg_auth_code, device_id, source_id, 0, AKEY_EVENT_ACTION_UP,
                                 no_flags, arbitrary_key_code, arbitrary_scan_code, no_modifiers, later_time);
...
TEST_P(InputTranslatorWithPolicyParam, forwards_policy_modifiers_as_flags_and_modifiers)
{
    ...
    droidinput::NotifyKeyArgs tester(some_time, msg_auth_code, device_id, source_id,
