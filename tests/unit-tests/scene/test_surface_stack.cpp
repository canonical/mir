...
TEST_F(SurfaceStack, occludes_not_rendered_surface)
{
    ...
    EXPECT_CALL(*mock_surface, configure(mir_window_attrib_visibility, mir_surface_visibility_occluded));
...
TEST_F(SurfaceStack, exposes_rendered_surface)
{
    ...
    EXPECT_CALL(*mock_surface, configure(mir_window_attrib_visibility, mir_surface_visibility_exposed));
...
TEST_F(SurfaceStack, overlays_do_not_appear_in_input_enumeration)
{
    ...
    stub_surface1->configure(mir_window_attrib_visibility, MirSurfaceVisibility::mir_surface_visibility_exposed);
    stub_surface2->configure(mir_window_attrib_visibility, MirSurfaceVisibility::mir_surface_visibility_exposed);
...
TEST_F(SurfaceStack, only_enumerates_exposed_input_surfaces)
{
    ...
    stub_surface1->configure(mir_window_attrib_visibility, MirSurfaceVisibility::mir_surface_visibility_exposed);
    stub_surface2->configure(mir_window_attrib_visibility, MirSurfaceVisibility::mir_surface_visibility_occluded);
    stub_surface3->configure(mir_window_attrib_visibility, MirSurfaceVisibility::mir_surface_visibility_occluded);
