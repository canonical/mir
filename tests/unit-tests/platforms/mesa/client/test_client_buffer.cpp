...
TEST_F(MesaClientBufferTest, DISABLE_width_and_height)
{
...
TEST_F(MesaClientBufferTest, DISABLE_buffer_returns_correct_stride)
{
    using namespace testing;
...
TEST_F(MesaClientBufferTest, DISABLE_buffer_returns_set_package)
{
    using namespace testing;
...
TEST_F(MesaClientBufferTest, DISABLE_secure_for_cpu_write_maps_buffer_fd)
{
    using namespace testing;
...
TEST_F(MesaClientBufferTest, DISABLE_secure_for_cpu_write_throws_on_map_failure)
{
    using namespace testing;
...
TEST_F(MesaClientBufferTest, DISABLE_buffer_fd_closed_on_buffer_destruction)
{
    using namespace testing;
...
TEST_F(MesaClientBufferTest, DISABLE_factory_gets_size_from_package)
{
    using namespace testing;
...
TEST_F(MesaClientBufferTest, DISABLE_creation_with_invalid_buffer_package_throws)
{
    using namespace testing;
...
TEST_F(MesaClientBufferTest, DISABLE_packs_empty_update_msg)
{
    using namespace testing;
    mclg::ClientBuffer buffer(buffer_file_ops, package, size, pf);
