 ...
 * The dispatcher is expected to be mostly asynchronous. */
 class InputDispatcherInterface : public virtual RefBase, public InputListenerInterface, public mir::input::InputSendObserver {
protected:
...
public:
    ...
    void send_failed(MirEvent const& event, mir::input::TransportSequenceID id, mir::input::Surface* surface, FailureReason reason) = 0;
    void send_suceeded(MirEvent const& event, mir::input::TransportSequenceID id, mir::input::Surface* surface, InputResponse response) = 0;
    void client_blocked(MirEvent const& event, mir::input::TransportSequenceID id, mir::input::Surface* client) = 0;
};
