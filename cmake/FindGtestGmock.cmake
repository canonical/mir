...
if (${CMAKE_CROSSCOMPILING})
  if (DEFINED MIR_TARGET_MACHINE)
    list(APPEND GTEST_CMAKE_ARGS -DMIR_TARGET_MACHINE=${MIR_TARGET_MACHINE})
  endif()
  if (DEFINED MIR_GCC_VARIANT)
    list(APPEND GTEST_CMAKE_ARGS -DMIR_GCC_VARIANT=${MIR_GCC_VARIANT})
  endif()
