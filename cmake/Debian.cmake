...
if (DPKG_BUILDFLAGS)
  ...
  execute_process(
    COMMAND ${DPKG_BUILDFLAGS} "--get" "FFLAGS"
    OUTPUT_VARIABLE DPKG_BUILDFLAGS_FFLAGS
    OUTPUT_STRIP_TRAILING_WHITESPACE
    )
  ...
  message(STATUS "DPKG_BUILDFLAGS_FFLAGS: " ${DPKG_BUILDFLAGS_FFLAGS})
  message(STATUS "DPKG_BUILDFLAGS_LDFLAGS: " ${DPKG_BUILDFLAGS_LDFLAGS})

  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${DPKG_BUILDFLAGS_CFLAGS} ${DPKG_BUILDFLAGS_FFLAGS}")
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${DPKG_BUILDFLAGS_CXXFLAGS} ${DPKG_BUILDFLAGS_FFLAGS}")
