...
struct ServerDecoration :
    mir::frontend::wayland::ServerDecoration
{
    ServerDecoration(struct wl_client *client, struct wl_resource *parent, uint32_t id) :
        mir::frontend::wayland::ServerDecoration::ServerDecoration(client, parent, id)
    {
...
struct ServerDecorationManager :
    mir::frontend::wayland::ServerDecorationManager
{
    using mir::frontend::wayland::ServerDecorationManager::ServerDecorationManager;
