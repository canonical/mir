...
bool me::CanonicalWindowManagerPolicyCopy::handle_key_event(MirKeyInputEvent const* event)
{
...
bool me::CanonicalWindowManagerPolicyCopy::handle_touch_event(MirTouchInputEvent const* event)
{
...
bool me::CanonicalWindowManagerPolicyCopy::handle_pointer_event(MirPointerInputEvent const* event)
{
