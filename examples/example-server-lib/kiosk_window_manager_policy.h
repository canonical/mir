...
#ifndef EXAMPLE_KIOSK_WINDOW_MANAGER_POLICY_H
#define EXAMPLE_KIOSK_WINDOW_MANAGER_POLICY_H
...
class KioskWindowManagerPolicyBase : public miral::CanonicalWindowManagerPolicy
{
public:
    KioskWindowManagerPolicyBase(miral::WindowManagerTools const& tools, MirWindowState target_state);
...
#endif /* EXAMPLE_KIOSK_WINDOW_MANAGER_POLICY_H */
