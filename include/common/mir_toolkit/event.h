...
#include "mir_toolkit/event_private.h"
...
/*
 * Retreive the MirSurfaceEvent associated with a MirEvent of
 * type mir_event_type_surface.
 *
 * \param [in] event The event
...
/*
 * Retreive the MirResizeEvent associated with a MirEvent of
 * type mir_event_type_resize.
 *
 * \param [in] event The event
...
/*
 * Retreive the MirPromptSessionEvent associated with a MirEvent of
 * type mir_event_type_prompt_session_state_change.
 *
 * \param [in] event The event
...
/*
 * Retreive the MirOrientationEvent associated with a MirEvent of
 * type mir_event_type_orientation.
 *
 * \param [in] event The event
...
/*
 * Retreive the MirCloseSurfaceEvent associated with a MirEvent of
 * type mir_event_type_close_surface.
 *
 * \param [in] event The event
