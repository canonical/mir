...
typedef enum {
    ...
    mir_pointer_input_event_action_change = 2
...
} MirPointerInputEventPointerAxis;
 ...
 */
MirPointerInputEventAction mir_pointer_input_event_get_pointer_action(MirPointerInputEvent const* event);
 ...
 */
float mir_pointer_input_event_get_pointer_axis_value(MirPointerInputEvent const* event, 
    size_t pointer_index, MirPointerInputEvent axis);
