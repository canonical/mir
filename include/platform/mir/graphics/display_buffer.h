...
public:
    ...
    /** This will render renderlist to the screen and post the result to the screen if
     *  there is a hardware optimization that can be done.
     *  \return true if the hardware can optimize the rendering of the list. When this call
     *          completes, the renderlist will have been posted to the screen.
     *          false if the hardware platform cannot optimize the list. The screen will not
     *          be updated. The caller should render the list another way, and call post_update()
    **/
