...
namespace miral
{
/// Enable configuring hover clickat runtime.
...
public:
    ...
    /// Called shortly after a hover click is scheduled
    HoverClick& on_hover_start(std::function<void()>&&);

    // Called immediately when a hover click is cancelled.
