...
public:
    ...
    virtual void add_trusted_participant(std::shared_ptr<Session> const& session) = 0;
    virtual void remove_trusted_participant(std::shared_ptr<Session> const& session) = 0;
