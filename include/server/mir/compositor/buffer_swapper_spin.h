...
{
public:
    explicit BufferSwapperSpin(std::initializer_list<std::shared_ptr<compositor::Buffer>> buffer_list);
    explicit BufferSwapperSpin(std::vector<std::shared_ptr<compositor::Buffer>> buffer_list);
