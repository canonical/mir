...
public:
    ...
    virtual void client_acquire(std::shared_ptr<Buffer>& buffer_reference, BufferID& dequeued_buffer) = 0;
    ...
    virtual void compositor_acquire(std::shared_ptr<Buffer>& buffer_reference, BufferID& acquired_buffer) = 0;
