...
public:
    ...
    void modify_surface(std::shared_ptr<scene::Session> const& session, std::shared_ptr<scene::Surface> const& surface, frontend::SurfaceModifications const& modifications) override;
