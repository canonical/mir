...
extern "C" std::shared_ptr<Platform> create_nested_platform(std::shared_ptr<options::Option> const& options, std::shared_ptr<NativePlatform> const& native_platform);
}
}
