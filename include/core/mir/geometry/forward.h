...
using PointD = generic::Point<double>;
using SizeD = generic::Size<double>;
using DisplacementD = generic::Displacement<double>;
using RectangleD = generic::Rectangle<double>;
}
}
